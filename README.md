...
# Run the local engineering lab and inspect honest stable-release blockers
sova acceptance run ./acceptance-output
sova acceptance evaluate ./external-receipts
