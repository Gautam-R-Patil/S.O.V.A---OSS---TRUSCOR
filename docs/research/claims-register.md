...
| P-20 | The optional MELRA `0.3.0-alpha.0` adapter plans and executes through a pinned, capability-probed MCP boundary and treats only the provider's embedded `verified_success` task state as success. | VERIFIED | Adapter owner | SRC-MELRA pinned commit `a6dd6710f5ae94e8ce825ef99df9b01d7f974b95`; [adapter boundary](../specifications/melra-adapter-boundary-0.1.md); adapter/broker tests and policy-blocked live receipt | 2026-08-04 | Every MELRA receipt, version, tool, or adapter change | The reviewed MELRA build had material Windows limitations; no general reliability, confidential architecture, roadmap, or independent-verification claim is made. |
