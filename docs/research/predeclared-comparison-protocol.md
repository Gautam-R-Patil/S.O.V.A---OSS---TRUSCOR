...
| Passive recorder | [OpenInference](https://github.com/Arize-ai/openinference) at `a1392c50d2d5b20fb805c195fb6006c80d5a6106` | Observe identical runs; it is not credited with discovery it does not attempt. |
